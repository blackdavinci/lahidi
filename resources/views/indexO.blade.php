...
<head>
    ...
    <!-- css -->
    <!-- Bootstrap Core CSS -->
{!! Html::style('css/bootstrap.min.cs') !!}
    <link href="css/eterna/bootstrap.css" rel="stylesheet" />
    <link href="css/eterna/bootstrap-responsive.css" rel="stylesheet" />
...
<a href="#" class="scrollup"><i class="icon-angle-up icon-square icon-bglight icon-2x active"></i></a>	
	...
	<script src="js/eterna/bootstrap.js"></script>
