          ...
          <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                ...
                <li><a href="#about">Promesses du Président</a></li>
                <li><a href="#contact">Promesses du Gouvernement</a></li>
                <li><a href="#contact">Médiathèque</a></li>
                <li><a href="#contact">Langues</a></li>
                <li><a href="#contact">Rapports</a></li>
                <li><a href="#contact">WebActu</a></li>
                <li class="dropdown">
