...
{{--*/ $i=0; $j=0; $c=0; /*--}}
	...
	<div class="row">
		...
		<div class="col-md-8">
			...
			@foreach($blogsext as $blogext)
				<div class="col-md-4 ligne-engagement ">
					
						<div class="col-md-12">
							@if(!empty($blogext->linkImage))
							<img src="{{$blogext->linkImage}}">
							@endif
						</div>
						<div class="col-md-12">
							<h5 class="text-justify">
								<strong>
									<a href="{{$blogext->lien}}">{{$blogext->titre}}</a>
								</strong>
							</h5>
							<p>{{substr($blogext->linkDescription,0,70)}}...</p>
						</div>
	...
	<div class="col-md-4">
		<div class=""><h4 ><strong><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Rapport MOSSEP</strong></h4></div>
